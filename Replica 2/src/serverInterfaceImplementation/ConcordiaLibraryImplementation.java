...
public class ConcordiaLibraryImplementation  {
...
//	}
	...
	public ConcordiaLibraryImplementation() {
		super();
		/*//log = //logger.get//logger(ConcordiaLibraryImplementation.class.getName());
		try {
			updateConServer//log(//log);
	...
	/*public void updateConServer//log(//logger //log) throws SecurityException, IOException {
	...
	public static HashMap<String, HashMap<String, Object>> getDataStore() {
		return dataStore;
	}
