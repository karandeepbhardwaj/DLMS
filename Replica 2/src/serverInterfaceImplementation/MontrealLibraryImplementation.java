...
public class MontrealLibraryImplementation {
...
//	{
//		//item1
//		dataStore.put("MON1111", new HashMap<String, Object>());
//		dataStore.get("MON1111").put(KEY_NAME, "Java");
//		dataStore.get("MON1111").put(KEY_QUANTITY, 5);
//		checkBook.put("MON1111", true);
//		//item2
//		dataStore.put("MON1234", new HashMap<String, Object>());
//		dataStore.get("MON1234").put(KEY_NAME, "DS");
//		dataStore.get("MON1234").put(KEY_QUANTITY, 6);
//		checkBook.put("MON1234", true);
//
//		//item3
//		dataStore.put("MON2222", new HashMap<String, Object>());
//		dataStore.get("MON2222").put(KEY_NAME, "CN");
//		dataStore.get("MON2222").put(KEY_QUANTITY, 4);
//		checkBook.put("MON2222", true);
//		//item4
//		dataStore.put("MON2345", new HashMap<String, Object>());
//		dataStore.get("MON2345").put(KEY_NAME, "CA");
//		dataStore.get("MON2345").put(KEY_QUANTITY, 3);
//		checkBook.put("MON2345", true);
//		//item5
//		dataStore.put("MON3456", new HashMap<String, Object>());
//		dataStore.get("MON3456").put(KEY_NAME, "AI");
//		dataStore.get("MON3456").put(KEY_QUANTITY, 7);
//		checkBook.put("MON3456", true);
//		//item6
//		dataStore.put("MON6789", new HashMap<String, Object>());
//		dataStore.get("MON6789").put(KEY_NAME, "ML");
//		dataStore.get("MON6789").put(KEY_QUANTITY, 2);
//		checkBook.put("MON6789", true);
//	}

	public MontrealLibraryImplementation() {
		super();
		log = Logger.getLogger(MontrealLibraryImplementation.class.getName());
		try {
			updateMonServerLog(log);
	...
	public String waitingQueueList(String userId, String itemId) {
		...
		if(itemId.substring(0, 3).equals("MCG")) {
			return requestToOtherServers(userId,itemId,4, null, ConstantValues.MCG_SERVER_PORT, null);
	...
	public String borrowItem(String userID, String itemID) {
		...
		if(!userID.substring(0,3).equals(ConstantValues.MONTREAL) && 
				(userBookMapping != null || !userBookMapping.isEmpty()) && userBookMapping.containsKey(userID)) {
					...
					for (String bookItemId : name) {
						if(bookItemId!=null && ConstantValues.MONTREAL.contains(bookItemId.substring(0, 3))) {
							return "You cannot borrow more than 1 book";
						}
					}
		}
		if(itemID.substring(0, 3).equals(ConstantValues.MONTREAL)) {
	...
	public String findItem(String userID, String itemName, boolean flag) { 
		log.info("Received request from " + userID +" for finding a book with book name "+itemName);
			...
			if(flag) {
			resultString += requestToOtherServers(userID, null, 1,itemName,ConstantValues.MCG_SERVER_PORT, null).trim();
	...
	public String bookExistOrNot(String userID, String newItemID, String oldItemID) {  
		...
		if(!userID.substring(0,3).equals(ConstantValues.MONTREAL) && 
				(userBookMapping != null || !userBookMapping.isEmpty()) && userBookMapping.containsKey(userID)) {
					...
					for (String bookItemId : name) {
						if(bookItemId.contains(ConstantValues.MONTREAL)) {
	...
	public String exchangeItem(String userId, String newItemID, String oldItemID) {
		...
		String bBook = null;
		if(oldItemID.substring(0, 3).equals(ConstantValues.MONTREAL)) {
		...
		if(newItemID.substring(0, 3).equals(ConstantValues.MONTREAL)) {
	...
	public void updateMonServerLog(Logger log) throws SecurityException, IOException {
		FileHandler fileHandler = new FileHandler(System.getProperty("user.dir")+"/Logger/"+"monserver"+".log", true);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MontrealLibraryImplementation other = (MontrealLibraryImplementation) obj;
		if (dataStore == null) {
	...
	public String requestToOtherServers(String userID, String itemId, int serverNumber,String itemName, int serPort, String oldItemID){
		log.info("Requesting other server from montreal");
		int serverPort;
		if(itemId != null) {
