...
public class LibraryManagementConstants {
	...
	public static final String REPLICA1_HOSTNAME="SINGER";//reshma system
	public static final String REPLICA2_HOSTNAME="SMALLEY"; // satish_system
	public static final String FRONT_END_HOSTNAME="SMALLEY"; // satish_system
	public static final String REPLICA3_HOSTNAME="SKOU";// namita_system
	public static final String SEQUENCER_HOSTNAME="SKOU";//namita_system
	public static final String REPLICA4_HOSTNAME="SIMON";//karan_system
...
//	public static final String REPLICA4_IPADDRESS="";
	...
	public static final String ADD_TO_WAIT = "EXCHANGE_ITEM";
